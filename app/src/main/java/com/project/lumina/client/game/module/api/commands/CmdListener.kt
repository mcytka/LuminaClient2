...
class CmdListener(private val moduleManager: GameManager) : Element(
    ...
    private fun stripColorCodes(text: String): String {
        // Fixed regex pattern - escape the backslash properly
    ...
    private fun extractUsername(message: String): String? {
        ...
        // Format 3: "[timestamp] username: message"
        ...
        return when {
            ...
            cleanMessage.contains(":") -> {
                ...
                if (parts.size >= 2) {
                    // Remove potential timestamp prefix like "[12:34] username"
                ...
                // Try to extract first word as username
